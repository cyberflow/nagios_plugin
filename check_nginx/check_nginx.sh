...
get_vals() {
    ...
    read=`echo ${out2}|awk '{print $12}'`
    write=`echo ${out2}|awk '{print $14}'`
    wait=`echo ${out2}|awk '{print $16}'`
...
do_perfdata() {
    perfdata="'reqpsec'=$reqpsec 'conpsec'=$conpsec 'read'=$read 'write'=$write 'wait'=$wait"
}
